...
13:00 Paper Discussion
  ...
  2. Private reflection
    ...
    * How do they test it? What are the main analytical methods?
      + HINT: You might want to look at the [supplementary metnods](http://science.sciencemag.org/content/sci/suppl/2013/10/16/342.6156.364.DC1/Colautti.SM.pdf)
    * Are the data publically available? If so, where?
...
Data Exercise:
  ...
  1. Finish entering GM data
  1. Work with your group using OpenRefine to create two data sheets:
  ...
  4. Visualize your data in R and inspect your graphs carefully
    1. Import one of your 'cleaned' .csv files
...
18:30 Lythrum dataset

  1. Locate and download data & metadata
  2. Inspect data and metadata
  3. Introduction to lm(), glm() and lmer()
  4. Attempt to reconstruct the analyses
