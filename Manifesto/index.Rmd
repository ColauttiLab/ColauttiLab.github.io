...
# Biology Code of Conduct

We also follow the Biology Department's Code of Conduct:

```{r label, out.width = "85%", fig.cap = "Biology Code of Conduct", echo=FALSE}
knitr::include_graphics("./BiologyCodeOfConduct.pdf")
```

[Download to Print](./BiologyCodeOfConduct.pdf)
