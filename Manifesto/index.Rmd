...
A series of 'onboarding' modules are now available through OnQ. Sign in with your Queen's ID and navigate to the Biology Department Onboarding page:

<https://onq.queensu.ca/d2l/home/516146>

## Basic Safety

These training modules are standard for the lab:

  1. <https://www.queensu.ca/risk/safety/training/whmis>
  2. <https://www.queensu.ca/risk/safety/training/biosafety>
  3. <https://colauttilab.github.io/Manifesto/FieldSafety.html>

## IDP

Create an Individual Development Plan (IDP). The IDP is designed to help you set and achieve goals for your project that align with your future career aspirations by addressing your weaknesses and building on your stengths. Before you begin, take a little while to think about your career goals and what you would like to accomplish with your thesis or dissertation. What skills or expertise would you like to develop? Who would you like to add to your professional network, and what would you like to see on your reference letters? How much time do you have to accomplish your goals?

Fill out [this IDP form](./Individual Development Plan.docx) 
...
* [ ] Complete appropriate 'onboarding' and safety modules
* [ ] Sign the graduate student contract
* [ ] Identify key papers and schedule a reading plan
* [ ] Complete the [Individual Development Plan (IDP)](./Individual Development Plan.docx)
* [ ] Prepare for one-on-one meetings with the [Regular Meeting Plan](./Regular Meeting Plan.docx)
...
Remember to leave enough time for other commitments like TA responsibilities, coursework, online training (ethics, lab safety, WHMIS). You can add these to the timeline developed in your IDP.
  
## Design Your Project

The [Individual Development Plan (IDP)](./Individual Development Plan.docx) is a document to guide you through your professional development, including your project development. Here are two additional approaches recommended in a [blog post by Dr. Kamoun](https://kamounlab.medium.com/gohrep-and-plesi-guides-to-navigate-through-your-research-projects-ae354a21f1bc). It's worth reading the whole thing, but here is a brief excerpt/summary:
