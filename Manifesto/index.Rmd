...
NOTES:
http://www.indiana.edu/~halllab/grad-student-resources.html
training & careers in STEM:
...
This document was inspired by the works of other, particularly [Steve Stearns](http://stearnslab.yale.edu/some-modest-advice-graduate-students) and [Ray Huey's response](./References/Huey_Reply.pdf), [John Thompson](./Reference/Thompson_Advice.pdf), and others. These perspectives are well worth reading and reflecting upon, particularly with respect to similarities and differences in philosophy.
...
1. __Data science__ -- Use basic programming (e.g. in R) to explore data, run statistical analysis, and produce graphs that help to explore and interpret the data, particularly in terms of hypothesis testing. 
...
> Create a new document to keep track of your skills. 
